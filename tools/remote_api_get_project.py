...
os.chdir('/home/jjr/var/thinktank')
from models.artifacts.project import Project
...
logging.info('Fetching project: ' + sys.argv[1])
project_dict = Project.get_by_id(
    '7ba7a3ab1b8911e6b33157df5888c59b').to_dict(-1, User.get_by_id('joe@corpus.io'), get_treeview=True)[0]
