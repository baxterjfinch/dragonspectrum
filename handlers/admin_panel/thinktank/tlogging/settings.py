...
__all__ = [
    'AjaxLoggingSettingHanlder',
]


class AjaxLoggingSettingHanlder(AuthorizationRequestHanlder):
    ...
    def get(self, organization=None):
        ...
        temp_data = {}
        template_index = JINJA_ENVIRONMENT.get_template('admin_panel/thinktank/logging/settings.html')
