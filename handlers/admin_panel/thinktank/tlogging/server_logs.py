...
__all__ = [
    'AjaxLoggingServerLogsHanlder',
]


class AjaxLoggingServerLogsHanlder(AuthorizationRequestHanlder):
    ...
    def get(self, organization=None):
        ...
        temp_data = {}
        template_index = JINJA_ENVIRONMENT.get_template('admin_panel/thinktank/logging/server_logs.html')
