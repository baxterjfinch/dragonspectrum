...
__all__ = [
    'AjaxLoggingAppEngineLogsHanlder',
]


class AjaxLoggingAppEngineLogsHanlder(AuthorizationRequestHanlder):
    ...
    def get(self, organization=None):
        ...
        temp_data = {}
        template_index = JINJA_ENVIRONMENT.get_template('admin_panel/thinktank/logging/app_engine_logs.html')
