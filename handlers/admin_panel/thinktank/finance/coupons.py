...
__all__ = [
    'AjaxFinanceCouponsHanlder',
]


class AjaxFinanceCouponsHanlder(AuthorizationRequestHanlder):
    ...
    def get(self, organization=None):
        ...
        temp_data = {}
        template_index = JINJA_ENVIRONMENT.get_template('admin_panel/thinktank/finance/coupons.html')
