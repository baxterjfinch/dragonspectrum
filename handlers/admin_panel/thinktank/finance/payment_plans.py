...
__all__ = [
    'AjaxFinancePaymentPlansHanlder',
]


class AjaxFinancePaymentPlansHanlder(AuthorizationRequestHanlder):
    ...
    def get(self, organization=None):
        ...
        temp_data = {}
        template_index = JINJA_ENVIRONMENT.get_template('admin_panel/thinktank/finance/payment_plan.html')
