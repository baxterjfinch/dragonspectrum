...
__all__ = [
    'AjaxThinkTankBackupHanlder',
]


class AjaxThinkTankBackupHanlder(AuthorizationRequestHanlder):
    ...
    def get(self, organization=None):
        ...
        temp_data = {}
        template_index = JINJA_ENVIRONMENT.get_template('admin_panel/thinktank/datastore/backup.html')
