...
__all__ = [
    'AjaxThinkTankRepairHanlder',
]


class AjaxThinkTankRepairHanlder(AuthorizationRequestHanlder):
    ...
    def get(self, organization=None):
        ...
        temp_data = {}
        template_index = JINJA_ENVIRONMENT.get_template('admin_panel/thinktank/datastore/repair.html')
