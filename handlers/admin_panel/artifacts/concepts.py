...
__all__ = [
    'AjaxArtifactsConceptHanlder',
]


class AjaxArtifactsConceptHanlder(AuthorizationRequestHanlder):
    ...
    def get(self, organization=None):
        ...
        temp_data = {}
        template_index = JINJA_ENVIRONMENT.get_template('admin_panel/artifacts/concepts.html')
